...
begin
 ...
 if (a>0)and(a<=size)and(b>0)and(b<=size)and(groupbox1.Left+(Timage(sender).Left+x) mod 25<>16)and(groupbox1.Top+(Timage(sender).Top+y) mod 25<>16)and((a>1)or(b>1)) then
  begin
