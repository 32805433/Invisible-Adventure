...
var
  ...
  pat,pbt,pct,pdt,dgood,dbad:integer;
...
begin
  label2.Caption:='';
  if pon then monsterlife:=monsterlife-3;
  monsterlife:=monsterlife-at;
  if monsterlife<=0 then
    begin
      fight:=false;
      if pon then Label2.Caption:='怪物中毒了！受到3点伤害！'+chr(13)+chr(10)+'你对怪物造成了'+inttostr(at)+'点伤害'+chr(13)+chr(10)+'战斗胜利！';
  ...
  if monsterlife>0 then
    begin
      if pon then Label2.Caption:='怪物中毒了！受到3点伤害！'+chr(13)+chr(10)+'你对怪物造成了'+inttostr(at)+'点伤害';
