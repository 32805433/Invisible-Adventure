...
var
  ...
  sb:array [1..25,1..25] of Tspeedbutton;
...
var a,b:integer;
    s:string;
begin
 a:=(groupbox1.Left+Timage(sender).Left+x+9) div sn;
 b:=size-((groupbox1.Top+Timage(sender).Top+y+9) div sn)+1;
 if (a>0)and(a<=size)and(b>0)and(b<=size)and(groupbox1.Left+(Timage(sender).Left+x) mod sn<>16)and(groupbox1.Top+(Timage(sender).Top+y) mod sn<>16)and((a>1)or(b>1)) then
  begin
